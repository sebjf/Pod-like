...
public class WaypointsEditor : Editor
{
    ...
    {
        var component = target as Waypoints;
    ...
    private void FindWidth(Waypoints component, Waypoint waypoint)
    {
        RaycastHit raycast;
    ...
    private void FindTangent(Waypoints component, Waypoint waypoint)
    {
